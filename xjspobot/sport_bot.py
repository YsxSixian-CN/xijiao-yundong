...
class Config:
    ...
    # ========== 用户信息配置 ==========
    USER = "3126358181"  # 学号/工号
    PASSWORD = "901599Ysx."  # 登录密码（请及时修改为您的实际密码）
    ...
    # 以米为单位的平面偏移
    dx = r * math.cos(theta)  # 东西方向
    dy = r * math.sin(theta)  # 南北方向

    # 米 -> 经纬度偏移
    lat_rad = math.radians(LATITUDE)
    d_lat = dy / EARTH_RADIUS
    d_lon = dx / (EARTH_RADIUS * math.cos(lat_rad))
    ...
    SMTP_AUTH_CODE = "duebzzulxstxdccb"  # QQ邮箱SMTP授权码
    EMAIL_SENDER = "3060587876@qq.com"  # 发件人邮箱地址
    EMAIL_RECEIVER = "3060587876@qq.com"  # 接收通知的邮箱地址
